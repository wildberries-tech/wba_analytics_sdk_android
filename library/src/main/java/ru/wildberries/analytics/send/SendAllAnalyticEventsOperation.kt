 ...
 * Работает, пока не закончатся события по правилам, описанным в конфиге [WBA2Config]
 * @see WBA2Config.Default
 * */
internal class SendAllAnalyticEventsOperation(
    ...
    tailrec suspend fun execute(apiData: ApiData, config: WBA2Config) {
    ...
    private suspend fun sendBatch(config: WBA2Config, apiData: ApiData) {
