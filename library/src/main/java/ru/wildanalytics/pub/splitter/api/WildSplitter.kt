...
import ru.wildanalytics.pub.splitter.impl.NoOpSplitterLogger
import ru.wildanalytics.pub.splitter.impl.SystemSplitterLogger
import ru.wildanalytics.pub.splitter.impl.WildSplitterImpl
import ru.wildanalytics.pub.splitter.impl.data.SplitterDatabase
import ru.wildanalytics.pub.splitter.impl.data.SplitterPropertiesRepositoryImpl
import ru.wildanalytics.pub.splitter.impl.data.SplitterRemoteDataSource
 ...
 * @see [WildSplitter.Factory.create] for creating an instance.
 */
public interface WildSplitter {
    ...
    public fun updateConfig(update: WildSplitterConfig.() -> WildSplitterConfig)
    ...
    public companion object Factory {
        ...
        /**
         * Creates an instance of [WildSplitter].
         *
         ...
         * @param systemLogsTag The tag for messages in LogCat (default is "WildSplitter").
         */
        @Synchronized
        public fun create(
            context: Context,
