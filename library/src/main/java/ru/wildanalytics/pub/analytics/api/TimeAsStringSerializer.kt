package ru.wildanalytics.pub.analytics.api
...
private val ISO_OFFSET_DATE_TIME_WITH_MS_MAX_FRACTION = DateTimeFormatterBuilder()
...
internal object TimeAsStringSerializer : KSerializer<OffsetDateTime> {
    ...
    override val descriptor = PrimitiveSerialDescriptor(
        "ru.wildanalytics.pub.analytics.api.TimeAsStringSerializer",
